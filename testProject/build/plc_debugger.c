 ...
 * Declare programs 
 **/
extern PROGRAM1 RES0__INSTANCE1;
extern PROGRAM2 RES0__INSTANCE2;
extern PROGRAM3 RES0__INSTANCE3;
extern PROGRAM4 RES0__INSTANCE4;
extern PROGRAM5 RES0__INSTANCE5;
extern PROGRAM6 RES0__INSTANCE6;
extern PROGRAM7 RES0__INSTANCE7;
...
{&(RES0__INSTANCE1.ESTOP), BOOL_ENUM},
{&(RES0__INSTANCE1.BOTTLE_JAM), BOOL_ENUM},
{&(RES0__INSTANCE1.SPEED_ENCODER), BOOL_ENUM},
{&(RES0__INSTANCE1.SPEED_CONTROL), BOOL_ENUM},
{&(RES0__INSTANCE1.CONVEYOR_ENABLE), BOOL_ENUM},
{&(RES0__INSTANCE1.CONVEYOR_MOTOR), BOOL_ENUM},
{&(RES0__INSTANCE1.ALARM_JAM), BOOL_ENUM},
{&(RES0__INSTANCE1.CONVEYOR_SPEED_COMMAND), BOOL_ENUM},
{&(RES0__INSTANCE1.LINE_LIGHT_TOWER), BOOL_ENUM},
{&(RES0__INSTANCE2.SWITCH_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE2.BOTTLE_PRESENCE_FILL), BOOL_ENUM},
{&(RES0__INSTANCE2.BOTTLE_PRESENCE_CAP), BOOL_ENUM},
{&(RES0__INSTANCE2.BOTTLE_PRESENCE_LABEL), BOOL_ENUM},
{&(RES0__INSTANCE2.STOP_CONVEYOR_FILL), BOOL_ENUM},
{&(RES0__INSTANCE2.STOP_CONVEYOR_CAP), BOOL_ENUM},
{&(RES0__INSTANCE2.STOP_CONVEYOR_LABEL), BOOL_ENUM},
{&(RES0__INSTANCE2.CONVEYOR_ENABLE), BOOL_ENUM},
{&(RES0__INSTANCE3.BOTTLE_PRESENCE_FILL), BOOL_ENUM},
{&(RES0__INSTANCE3.OPTICAL_NECK_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_TIMER), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_FLOWRATE), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_TEMPERATURE), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_ENABLE), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_VALVE), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_PUMP_SPEED), BOOL_ENUM},
{&(RES0__INSTANCE3.FILL_ALARM), BOOL_ENUM},
{&(RES0__INSTANCE4.MIN_TANK_LEVEL), BOOL_ENUM},
{&(RES0__INSTANCE4.PRSSURE_PUMP), BOOL_ENUM},
{&(RES0__INSTANCE4.PUMP_ENABLE), BOOL_ENUM},
{&(RES0__INSTANCE4.FILL_PUMP_SPEED), BOOL_ENUM},
{&(RES0__INSTANCE4.TANK_ALARM), BOOL_ENUM},
{&(RES0__INSTANCE5.MIN_CAP_HOPPER_LEVEL), BOOL_ENUM},
{&(RES0__INSTANCE5.CAP_PRESENCE_HOPPER), BOOL_ENUM},
{&(RES0__INSTANCE5.MIN_CAP_TORQUE_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE5.MAX_CAP_TORQUE_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE5.CAPPING_ENABLE), BOOL_ENUM},
{&(RES0__INSTANCE5.ALARM_CAPS), BOOL_ENUM},
{&(RES0__INSTANCE5.CAP_BOTTLE), BOOL_ENUM},
{&(RES0__INSTANCE5.ACTUATOR_ALARM), BOOL_ENUM},
{&(RES0__INSTANCE6.BOTTLE_PRESENCE_LABEL), BOOL_ENUM},
{&(RES0__INSTANCE6.LABEL_PRESENCE), BOOL_ENUM},
{&(RES0__INSTANCE6.LABEL_POSITIONING), BOOL_ENUM},
{&(RES0__INSTANCE6.LABEL_APPLICATOR), BOOL_ENUM},
{&(RES0__INSTANCE6.ACTUATOR_ALARM), BOOL_ENUM},
{&(RES0__INSTANCE7.FILL_LEVEL_DETECT), BOOL_ENUM},
{&(RES0__INSTANCE7.OPTICAL_NECK_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE7.BOTTLE_WEIGHT), BOOL_ENUM},
{&(RES0__INSTANCE7.CAP_TORQUE_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE7.REJECT_BOTTLE), BOOL_ENUM}
};
